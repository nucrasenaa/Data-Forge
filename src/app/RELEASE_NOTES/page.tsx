                ...
                <aside className="w-64 shrink-0 space-y-8 sticky top-28 h-fit">
                    ...
                    <section>
                        ...
                        <div className="space-y-1 px-2">
                            {[
                                { ver: 'v1.4.1', label: '2026-03-10', badge: 'Latest', color: 'text-accent bg-accent/10 border-accent/20' },
                                { ver: 'v1.4.0', label: '2026-03-10', badge: '', color: 'text-muted-foreground bg-muted/30 border-border/30' },
